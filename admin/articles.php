...
<div class="container">
    <h1 id="welcome">مقالات منتشر شده</h1>
    <table class="table">
        <thead>
        <tr>
            <th scope="col">#</th>
        ...
        <tr>
            ...
            <td><a href="articleDelete.php ? id=<?= $bloginfo['id']?>" class="btn btn-danger">حذف</a> <a href="articleEdit.php?id=<?= $bloginfo['id']?>" class="btn btn-warning">ویرایش</a></td>
        </tr>
        </tbody>
        <?php endforeach; ?>
    </table>
